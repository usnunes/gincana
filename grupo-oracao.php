...
<html lang="en" class="h-100">
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header"><h2 style="text-align: center;">Pontuação por Participação em Grupo de Oração</h2></div>
        ...
        <?php
            ...
            $go4 = 0+40; //Vermelho - Santo Agostinho 
            $go5 = 10+10; //Verde - São Rafael
            $go6 = 0+0; //Amarelo - São Sebastião
            $go7 = 10+0; //Laranja - São Miguel
            $go8 = 0+0; //Branco - São Domingo Sávio
        ?>
    </div>
    </div>
    </main>
    ...
    <div class="container" style="text-align: center;">
        ...
        const myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Pontuação',
                    data: [ "<?php echo $go1;?>", "<?php echo $go2;?>",
                            "<?php echo $go3;?>", "<?php echo $go4;?>",
                            "<?php echo $go5;?>", "<?php echo $go6;?>",
                            "<?php echo $go7;?>", "<?php echo $go8;?>"],
                    backgroundColor: [
                        'RGBA( 0, 0, 0, 1 )',
                        'RGBA( 138, 43, 226, 1 )',
                        'RGBA( 0, 0, 255, 1 )',
